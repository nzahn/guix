# Compare guix_studio_cli generate output to a committed golden file.
#
# Required variables:
...
execute_process(
  COMMAND "${GUIX_STUDIO_CLI}" generate --project "${GUIX_PROJECT}" --output_path "${TMP_DIR}" --json
  RESULT_VARIABLE rc
  OUTPUT_VARIABLE out
  ERROR_VARIABLE err
)
if(NOT rc EQUAL 0)
  ...
  message(FATAL_ERROR "generate failed (${rc}): ${err}")
endif()
...
if(NOT diff_rc EQUAL 0)
  message(FATAL_ERROR "Golden mismatch for ${GUIX_PROJECT} (generate).
Golden: ${GOLDEN_XML}
Actual: ${actual_xml}")
endif()
