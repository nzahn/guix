...
- [ ] Implement/port resource generation and binary resource generation
  - [x] `generate --binary` emits a minimal, loadable GUIX binres (headers + string table; placeholder empty theme resources; smoke tested for multi-language + `--no_res_header`)
